...
struct EditTaskView: View {
    ...
    let taskID: String
    @StateObject private var vm: EditTaskViewModel

    init(taskID: String) {
        self.taskID = taskID
        _vm = StateObject(wrappedValue: EditTaskViewModel(taskID: taskID))
    }
            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        Text("Başlık, açıklama, durum ve bitiş tarihini güncelle.")
                            .font(.subheadline)
